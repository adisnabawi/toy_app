class Micropost2sController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @micropost2.save
        ...
        format.json { render :show, status: :created, location: @micropost2 }
      else
  ...
  def update
    respond_to do |format|
      if @micropost2.update(micropost2_params)
        ...
        format.json { render :show, status: :ok, location: @micropost2 }
      else
  ...
  def destroy
    @micropost2.destroy
    respond_to do |format|
      format.html { redirect_to micropost2s_url, notice: 'Micropost2 was successfully destroyed.' }
